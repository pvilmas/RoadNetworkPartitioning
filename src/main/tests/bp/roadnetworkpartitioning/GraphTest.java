...
class GraphTest {
    ...
    void mergeGraphs() {
        ...
        Map<Integer, Edge> edges = new HashMap<>();
        edges.put(1, new Edge(1, vertices.get(1), vertices.get(2), 5));
        edges.put(21, new Edge(2, vertices.get(1), vertices.get(4), 5));
        edges.put(3, new Edge(3, vertices.get(2), vertices.get(3), 5));
        edges.put(4, new Edge(4, vertices.get(2), vertices.get(1), 5));
        edges.put(23, new Edge(5, vertices.get(2), vertices.get(5), 5));
        edges.put(6, new Edge(6, vertices.get(3), vertices.get(2), 5));
        edges.put(7, new Edge(25, vertices.get(3), vertices.get(6), 5));
        edges.put(8, new Edge(8, vertices.get(4), vertices.get(5), 5));
        edges.put(22, new Edge(9, vertices.get(4), vertices.get(1), 5));
        edges.put(10, new Edge(11, vertices.get(5), vertices.get(6), 5));
        edges.put(11, new Edge(13, vertices.get(5), vertices.get(4), 5));
        edges.put(24, new Edge(12, vertices.get(5), vertices.get(2), 5));
        edges.put(13, new Edge(16, vertices.get(6), vertices.get(5), 5));
        edges.put(14, new Edge(26, vertices.get(6), vertices.get(3), 5));
